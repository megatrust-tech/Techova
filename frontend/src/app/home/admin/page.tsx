      ...
      <main className="page-shell">
        ...
        <header className="page-header" style={{ marginBottom: "32px" }}>
          <div>
            ...
            <p className="muted">
              Configure company-wide policies, default leave balances, and
              auto-approval rules.
            </p>
          </div>
          <div>
        ...
        >
          <div
            ...
            onClick={() => router.push("/home/admin/balances")}
            onMouseEnter={(e) => {
        ...
        <section className="card">
              ...
              <tbody>
                {settings.length === 0 && (
                  <tr>
                    ...
                    >
                      No leave types found. Please check your database or
                      backend connection.
                    </td>
                  </tr>
                )}
                      ...
                      >
                        ...
                        <span
                          style={{
                            fontSize: "14px",
                            fontWeight: "500",
                            color: setting.autoApproveEnabled
                              ? "#7b58ca"
                              : "#94a3b8",
                          }}
                        >
                    ...
                    <td style={{ padding: "16px" }}>
                      <div
                        style={{
                          ...
                          alignItems: "center",
                          gap: "8px",
                          opacity: setting.autoApproveEnabled ? 1 : 0.5,
                        }}
                      >
                        <span style={{ fontSize: "14px", color: "#94a3b8" }}>
                          &le;
          ...
          >
            <p style={{ margin: 0 }}>
              ...
              &bull; <strong>Default Balance:</strong> Changes affect employees
              created <em>after</em> this save. <br />
              &bull; <strong>Auto-Approval:</strong> Rules take effect
              immediately. Requests within the threshold skip Manager approval.
            </p>
          </div>
        </section>
      </main>
