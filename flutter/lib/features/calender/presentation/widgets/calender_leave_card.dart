                    ...
                    children: [
                      Row(
                        children: [
                          CircleAvatar(
                            radius: 18,
                            backgroundColor: AppColors.unSelectedColor.withOpacity(.2),
                            child: Icon(Icons.person, color: AppColors.textColor, size: 18),
                          ),
                      ...
                      _row(l10n.leaveTypeLabel, leave.leaveType ?? '—'),
                      _row(l10n.leaveStartLabel, _fmt(leave.startDate)),
                      _row(l10n.leaveEndLabel, _fmt(leave.endDate)),
                      if ((leave.notes ?? '').trim().isNotEmpty)
                        _row(l10n.leaveNotesLabel, (leave.notes ?? '').trim()),
                    ],
                  ),
                ),
              ),
