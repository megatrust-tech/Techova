...
public class LeaveRequestsController : ControllerBase
{
    ...
    [Authorize(Roles = "Admin")]
    public async Task<IActionResult> GetUsersWithoutBalances([FromQuery] PaginationDto pagination)
    {
        var users = await _leaveService.GetUsersWithoutBalancesAsync(pagination);
        return Ok(users);
    }
    ...
    [Authorize(Roles = "Admin")]
    public async Task<IActionResult> GetAllUsersWithBalances([FromQuery] PaginationDto pagination)
    {
        var result = await _leaveService.GetAllUsersWithBalancesAsync(pagination);
        return Ok(result);
    }
